...
import { BookText, CalendarDays, UserCircle } from 'lucide-react'; // Example icons
          ...
          {placeholderArticles.map((article) => (
            <Card key={article.id} className="shadow-soft rounded-2xl flex flex-col overflow-hidden">
              ...
              <div className="p-6 pt-0">
                 <Button variant="outline" className="w-full mt-2 border-deep-teal text-deep-teal hover:bg-deep-teal/10">
