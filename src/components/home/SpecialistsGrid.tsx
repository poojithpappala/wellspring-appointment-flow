    ...
    <section className="section-padding bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto">
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 mb-6">Looking for a specific specialty?</p>
          <Button variant="outline" size="lg" className="border-2 border-deep-teal text-deep-teal hover:bg-deep-teal hover:text-white px-8 py-3 rounded-xl transition-all duration-300">
